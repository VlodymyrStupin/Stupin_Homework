...
public class Task4 {
    public static void main(String[] args) {
        ...
        System.out.println("Array with deleted element and shift to left " +
                Arrays.toString(deleteElementFromArrayAndShiftToLeft(justArray, indexElementInArray)));
        System.out.println("Original array " + Arrays.toString(justArray));
    }

    public static int[] deleteElementFromArrayAndShiftToLeft(int[] justArray, int indexElementInArray) {
